...
public class Canvasing extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_canvasing);
        ...
        listener = new Adapter.RecyclerViewClickListener() {
            ...
            public void onRowClick(View view, final int position) {
                ...
                Intent intent = new Intent(Canvasing.this, EditCanvasing.class);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(Canvasing.this, EditCanvasing.class));
            }
        });
    ...
    public void getPets(){
        ...
        Call<List<Pets>> call = apiInterface.getPets("get", name);
        call.enqueue(new Callback<List<Pets>>() {
            ...
            public void onResponse(Call<List<Pets>> call, Response<List<Pets>> response) {
                ...
                Log.i(Canvasing.class.getSimpleName(), response.body().toString());
                adapter = new Adapter(petsList, Canvasing.this, listener);
            ...
            public void onFailure(Call<List<Pets>> call, Throwable t) {
                Toast.makeText(Canvasing.this, "rp :"+
    ...
    public void updateLove(final String key, final int id, final Boolean love){
        ...
        call.enqueue(new Callback<Pets>() {
            ...
            public void onResponse(Call<Pets> call, Response<Pets> response) {
                ...
                Log.i(Canvasing.class.getSimpleName(), "Response "+response.toString());

                String value = response.body().getValue();
                String message = response.body().getMassage();

                if (value.equals("1")){
                    Toast.makeText(Canvasing.this, message, Toast.LENGTH_SHORT).show();
                } else {
                    Toast.makeText(Canvasing.this, message, Toast.LENGTH_SHORT).show();
                }
            ...
            public void onFailure(Call<Pets> call, Throwable t) {
                Toast.makeText(Canvasing.this, t.getMessage().toString(), Toast.LENGTH_SHORT).show();
            }
        });
    }
