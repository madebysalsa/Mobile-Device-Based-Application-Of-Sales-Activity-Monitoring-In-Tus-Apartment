...
public class AbsenDatang extends AppCompatActivity {
    ...
    String  nama_absen_datang, lokasi_absen_datang, waktu, foto;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nama = findViewById(R.id.nama_absen_datang);
        nama.setText(preferenceHelper.getUsername());
        nama.setFocusableInTouchMode(false);
        lokasi = findViewById(R.id.lokasi_absen_datang);
        ...
        btn_tambah.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                nama_absen_datang = nama.getText().toString();
                lokasi_absen_datang = lokasi.getText().toString();
                ...
                if(nama_absen_datang.trim().equals("")){
                    nama.setError("Nama Harus Dipilih");
                } if(lokasi_absen_datang.trim().equals("")){
    ...
    private void getLocation() {
        if (ActivityCompat.checkSelfPermission(
                AbsenDatang.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(
                AbsenDatang.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
    ...
    private void createData(){
        ...
        Call<DataAbsenDatang> call = ardData.addAbsenDatang("insert", nama_absen_datang, lokasi_absen_datang, waktu, foto);

        call.enqueue(new Callback<DataAbsenDatang>() {
            @Override
            public void onResponse(Call<DataAbsenDatang> call, Response<DataAbsenDatang> response) {
                String kode = response.body().getValue();
                String pesan = response.body().getMassage();

                Toast.makeText(AbsenDatang.this, "Kode : "+kode+" | Pesan : "+pesan, Toast.LENGTH_SHORT).show();
                finish();
            }

            @Override
            public void onFailure(Call<DataAbsenDatang> call, Throwable t) {
                Toast.makeText(AbsenDatang.this, "Gagal Menghubungi Server | "+t.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
